...
const customFontSizes = {
  displayLarge: { fontSize: 63, lineHeight: 72 },
  displayMedium: { fontSize: 51, lineHeight: 60 },
  displaySmall: { fontSize: 42, lineHeight: 50 },
  headlineLarge: { fontSize: 38, lineHeight: 46 },
  headlineMedium: { fontSize: 34, lineHeight: 42 },
  headlineSmall: { fontSize: 30, lineHeight: 38 },
  titleLarge: { fontSize: 25, lineHeight: 32 },
  titleMedium: { fontSize: 22, lineHeight: 28 },
  titleSmall: { fontSize: 20, lineHeight: 26 },
  labelLarge: { fontSize: 20, lineHeight: 26 },
  labelMedium: { fontSize: 18, lineHeight: 24 },
  labelSmall: { fontSize: 17, lineHeight: 22 },
  bodyLarge: { fontSize: 22, lineHeight: 28 },
  bodyMedium: { fontSize: 20, lineHeight: 26 },
  bodySmall: { fontSize: 17, lineHeight: 22 },
}
