...
echo "   7. List the available backups: $ADB_CMD shell bmgr list sets"
echo "   8. Restore: $ADB_CMD shell bmgr restore $TOKEN $PACKAGE_NAME"
echo "   9. Open app and verify data is present"
echo ""
